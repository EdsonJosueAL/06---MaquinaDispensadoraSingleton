 ...
 *
 */
public final class ModeloRegresco {
	private JLabel[] b;
	private int total = 0;
	private JCheckBox[] a;
	...
	private final static ModeloRegresco mRefresco = new ModeloRegresco();
	
	private ModeloRegresco() {
		// TODO Auto-generated constructor stub
	}
	
	public static ModeloRegresco getInstanceRefresco(){
		return mRefresco;
	}
	
	public void ModeloRegrescoFun(JLabel[] b, JCheckBox[] a) {
		this.b = b;
		this.a = a;
	}
