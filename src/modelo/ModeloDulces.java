 ...
 *
 */
public final class ModeloDulces {
	private JLabel[] b;
	private int total = 0;
	private JCheckBox[] a;
	...
	private final static ModeloDulces mDulces = new ModeloDulces();
	
	/**
	 * Constructor por defecto
	 */
	private ModeloDulces() {
	}
	
	public static ModeloDulces getInstanceDulces(){
		return mDulces;
	}
	/**
	 ...
	 */
	public void ModeloDulcesFun(JLabel[] b, JCheckBox[] a) {
		this.b = b;
		this.a = a;
	}
	/**
	 * Mètodo get que devuelve un arreglo
	...
	/**
	 * Mètodo get que devuelve un valor int
	 ...
	 * @param a valor que se asiganarÃ¡ al arreglo
	 */
