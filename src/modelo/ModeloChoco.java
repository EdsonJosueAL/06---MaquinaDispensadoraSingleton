 ...
 *
 */
public final class ModeloChoco {
	private JLabel[] b;
	private int total = 0;
	private JCheckBox[] a;
	...
	private final static ModeloChoco mChoco = new ModeloChoco();
	/**
	...
	public static ModeloChoco getInstanceChoco(){
		return mChoco; 
	}
	
	public void ModeloChocoFun(JLabel[] bc, JCheckBox[] ac) {
		this.b = b;
		this.a = a;
	}
	/**
